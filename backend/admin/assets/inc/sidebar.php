                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="appointment.php">Schedule_appointment</a>
                                    </li>
                                    <li>
                                        <a href="view_appointments.php">View_appointment</a>
                                    </li>
                                    <li>
                                        <a href="view_appointment.php">Approve_appointment</a>
                                    </li>
                                    <li>
                                        <a href="retrieve_patient_credentials.php">patient_credentials</a>
                                    </li>
                                    <li>
                                        <a href="approved_appointments.php">Approved appointmets</a>
                                    </li>
                                    <li>
                                        <a href="Video Chat with Patient.php">Video Chat with Patients</a>
                                    </li>
                                </ul>
                            </li>
