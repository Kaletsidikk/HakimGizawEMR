...
if (isset($_POST['add_appointment'])) {
    ...
    if ($stmt) {
        ...
        $message = "Hello, Your appointment is scheduled for $appointment_date at $appointment_time with Dr. $doctor_name Please be on time.";
...
function sendSMSReminder($phone_number, $message) {
    // Replace with your Infobip API credentials
