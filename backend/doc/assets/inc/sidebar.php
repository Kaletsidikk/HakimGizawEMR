                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="view_appointments.php">View Appointment</a>
                                    </li>
                                    <li>
                                        <a href="approve_appointment.php">Approve Appointment</a>
                                    </li>
                                    <li>
                                        <a href="retrive_patient_credintials.php">Patient credintials</a>
                                    </li>
                                </ul>
                            </li>
