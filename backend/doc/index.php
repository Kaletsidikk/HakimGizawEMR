                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Enter your email address and password to access Staff panel.</p>
                                </div>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="doc_number" type="text" id="emailaddress" required="" placeholder="Enter your employee number">
                                    </div>
